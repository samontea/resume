...
\begin{tabular}{r@{\hskip 9pt} l}
  ...
  Citizenship: Ireland, United States (Dual Citizen) & Github: \url{https://github.com/samontea}
\end{tabular}
\end{center}
%\makecvtitle
\vspace{-22pt}
...
\cvitemwithcomment{}{\textbf{Software Engineer 2} MongoDB (New York) -- Query Team}{Aug. 2020--Present}
